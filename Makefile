...
LINE_MNEMONICS_OBJS = $(addprefix line/mnemonics/, ALUDataInstr.o Mnemonic.o ImmediateInstr.o NoOperandInstr.o)
LINE_MNEMONICS_TEST_OBJS = $(addprefix line/mnemonics/, ALUDataInstrTest.o ImmediateInstrTest.o NoOperandInstrTest.o)
