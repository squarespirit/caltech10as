...
LINE_MNEMONICS_OBJS = $(addprefix line/mnemonics/, ALUDataInstr.o DirectInstr.o Mnemonic.o ImmediateInstr.o NoOperandInstr.o SymbolInstr.o)
LINE_MNEMONICS_TEST_OBJS = $(addprefix line/mnemonics/, ALUDataInstrTest.o DirectInstrTest.o ImmediateInstrTest.o NoOperandInstrTest.o SymbolInstrTest.o)
